// ==UserScript==
// @name            EnMT - Tiberium Alliances Combat Simulator
// @description     EnMT personal use
// @author          Devenv
// @version         13.12.08
...
unsafeWindow.report_combat_sim = report_combat_sim;
unsafeWindow.get_combat_sims = get_combat_sims;
                ...
                members: {
                    ...
                    Simulation: function (instance) {
                        try {
                            ...
                            this.setSimulation = function (data, ownCity) {
                                window.last_sim_data = data;
                                simulated = true;
                                if(ownCity) {
